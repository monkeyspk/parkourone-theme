...
/**
 * Title: Impressum
 * Slug: parkourone/page-impressum
 * Categories: parkourone-seiten
 * Description: Impressum Vorlage (rechtlich vorgeschrieben)
 * Keywords: impressum, legal, kontakt, imprint
 * Viewport Width: 1200
...
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Inhalt und Konzept</h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p>Verweise und Links auf Webseiten Dritter liegen ausserhalb unseres Verantwortungsbereichs. Es wird jegliche Verantwortung für solche Webseiten abgelehnt. Zugriff und Nutzung solcher Webseiten erfolgen auf eigene Gefahr des Nutzers oder der Nutzerin.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Die Urheber- und alle anderen Rechte an Inhalten, Bildern, Fotos oder anderen Dateien auf der Website gehören ausschliesslich der Firma ParkourONE GmbH oder den speziell genannten Rechtsinhabern. Für die Reproduktion jeglicher Elemente ist die schriftliche Zustimmung der Urheberrechtsträger im Voraus einzuholen.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Gestützt auf Artikel 13 der schweizerischen Bundesverfassung und die datenschutzrechtlichen Bestimmungen des Bundes (Datenschutzgesetz, DSG) sowie die DSGVO hat jede Person Anspruch auf Schutz ihrer Privatsphäre sowie auf Schutz vor Missbrauch ihrer persönlichen Daten. Wir halten diese Bestimmungen ein. Persönliche Daten werden streng vertraulich behandelt und weder an Dritte verkauft noch weitergegeben.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>In enger Zusammenarbeit mit unseren Hosting-Providern bemühen wir uns, die Datenbanken so gut wie möglich vor fremden Zugriffen, Verlusten, Missbrauch oder Fälschung zu schützen.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Beim Zugriff auf unsere Webseiten werden folgende Daten in Logfiles gespeichert: IP-Adresse, Datum, Uhrzeit, Browser-Anfrage und allgemein übertragene Informationen zum Betriebssystem resp. Browser. Diese Nutzungsdaten bilden die Basis für statistische, anonyme Auswertungen, sodass Trends erkennbar sind, anhand derer wir unsere Angebote entsprechend verbessern können.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Ausführliche Informationen zum Datenschutz finden Sie auf unserer <a href="/datenschutz/">Datenschutzseite</a>.</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Datenschutzerklärung für die Nutzung von Facebook-Plugins (Like-Button)</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Auf unseren Seiten sind Plugins des sozialen Netzwerks Facebook, 1601 South California Avenue, Palo Alto, CA 94304, USA integriert. Die Facebook-Plugins erkennt man am Facebook-Logo oder "Like-Button" ("Gefällt mir") auf unserer Seite. Eine Übersicht über die Facebook-Plugins findet sich hier: http://developers.facebook.com/docs/plugins/.</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>Wenn Sie nicht wünschen, dass Facebook den Besuch unserer Seiten Ihrem Facebook-Nutzerkonto zuordnen kann, loggen Sie sich aus Ihrem Facebook-Benutzerkonto aus.</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading">Datenschutzerklärung für die Nutzung von Google Analytics</h2>
<!-- /wp:heading -->
