...
/**
 * Title: Datenschutz
 * Slug: parkourone/page-datenschutz
 * Categories: parkourone-seiten
 * Description: Datenschutzerklärung Vorlage (DSGVO-konform)
 * Keywords: datenschutz, privacy, dsgvo, legal
 * Viewport Width: 1200
...
<!-- wp:heading {"level":1} -->
<h1 class="wp-block-heading">Was mit deinen Daten passiert</h1>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p><strong>ParkourONE Berlin</strong><br>Scheffler & Gessinger GbR<br>Vertreten durch: Ben Scheffler<br>Dietzinger Straße 25<br>13156 Berlin<br>Deutschland<br>E-Mail: berlin@parkourone.com</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Gesetzlich vorgeschriebener Datenschutzbeauftragter</h3>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p>Roger Widmer<br>ParkourONE GmbH<br>Könizstrasse 161<br>3097 Liebefeld<br>Schweiz</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Telefon: +41 31 371 74 90<br>E-Mail: roger(at)parkourone.com</p>
<!-- /wp:paragraph -->
...
<!-- wp:heading {"level":3} -->
<h3 class="wp-block-heading">Datenübermittlung bei Vertragsschluss für Dienstleistungen und digitale Inhalte</h3>
<!-- /wp:heading -->
